...
def index(request):
    ...
    return render(request,'django index.html')# render have three argument one is necessary request and you put one for run server some any html file and third is filez
# def capital(request):
